/**
 * Pure helpers for dashboard metrics that are computed from raw event/entry
 * timestamps rather than stored directly — kept out of the page component so
 * the date-math is unit-testable in isolation from Supabase calls.
 */
...
/** Time-of-day greeting in the student's own timezone, not the server's. */
