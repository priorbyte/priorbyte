...
export const metadata: Metadata = { title: 'Quiz Generator' };
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="mt-2 text-4xl">Quiz Generator</h1>
        <p className="mt-2 max-w-2xl text-silver">
          Paste material, get quizzed, and see why a wrong answer is wrong.
        </p>
      </div>
      <QuizForm />
    </div>
