...
export const metadata: Metadata = { title: 'Lecture Summarizer' };
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="mt-2 text-4xl">Lecture Summarizer</h1>
        <p className="mt-2 max-w-2xl text-silver">
          Paste a transcript, get a chronological review. Audio transcription isn&apos;t built
          yet — paste text for now.
        </p>
      </div>
      <LectureForm />
    </div>
